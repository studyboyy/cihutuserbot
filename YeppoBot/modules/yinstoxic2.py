...
@yeppo_cmd(pattern=r"ngentot(?: |$)(.*)")
async def _(yeppo):
    yins = await eor(yeppo, get_string("yitxc_23"))
    sleep(1)
...
@yeppo_cmd(pattern=r"goblok(?: |$)(.*)")
async def _(gblk):
    yeppo = await eor(gblk, get_string("yitxc_33"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_34"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_35"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_36"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_37"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_38"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_39"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_40"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_41"))
    sleep(1)
    await yeppo.edit(get_string("yitxc_42"))
# Create by myself @localheart


@yeppo_cmd(pattern=r"ngatain(?: |$)(.*)")
async def _(kntl):
...
@yeppo_cmd(pattern=r"yatim(?: |$)(.*)")
async def _(ytim):
    YeppoBot = await eor(ytim, get_string("yitxc_53"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_54"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_55"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_56"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_57"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_58"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_59"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_60"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_61"))
    sleep(1)
    await YeppoBot.edit(get_string("yitxc_62"))
# Create by myself @localheart


@yeppo_cmd(pattern=r"kont(?: |$)(.*)")
async def _(kontol):
