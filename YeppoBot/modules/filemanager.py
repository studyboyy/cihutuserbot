...
from YeppoBot.yeppo import humanbytes, yeppo_cmd
from Stringyins import get_string

MAX_MESSAGE_SIZE_LIMIT = 4095


@yeppo_cmd(pattern="ls(?: |$)(.*)")
async def lst(event):
    if event.fwd_from:
        return
