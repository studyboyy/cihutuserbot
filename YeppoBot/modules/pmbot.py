...
from YeppoBot import CMD_HELP, bot, tgbot, user
from YeppoBot.modules.sql_helper.bot_blacklists import (
    add_user_to_bl,
    check_is_black_list,
    get_all_bl_users,
    rem_user_from_bl,
)
from YeppoBot.modules.sql_helper.bot_pms_sql import get_user_id
...
@yeppo_cmd(pattern="(set|reset) pmbot(?: |$)(\\w*)")
