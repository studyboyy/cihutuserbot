...
# from YeppoBot.events import humanbytes, progress, time_formatter
from YeppoBot import CMD_HELP, GIT_REPO_NAME, GITHUB_ACCESS_TOKEN, bot
from YeppoBot.yeppo import yeppo_cmd
from Stringyins import get_string

GIT_TEMP_DIR = "./YeppoBot/temp/"


@yeppo_cmd(pattern="gcommit(?: |$)(.*)")
...
async def git_commit(file_name, mone):
    ...
    file_name = f"YeppoBot/modules/{file_name}"
    if create_file:
        file_name = file_name.replace("./YeppoBot/temp/", "")
        print(file_name)
        try:
            repo.create_file(
