...
from YeppoBot.yeppo.misc import Carbon
...
async def crbn(event):
    ...
    xx = await Carbon(code=code, file_name="carbon_yeppo", backgroundColor=col)
    await xxxx.delete()
