...
import YeppoBot.modules.sql_helper.gban_sql as gban_sql
from YeppoBot import BOTLOG_CHATID
from YeppoBot import CMD_HANDLER as cmd
from YeppoBot import CMD_HELP, DEVS, WHITELIST, blacklistyeppo
from YeppoBot.events import register
from YeppoBot.yeppo import yeppo_cmd, chataction, edit_or_reply, get_user_from_event
...
async def _(event):
    if event.user_joined or event.added_by:
        ...
        if gban_sql.is_gbanned(
                user.id) and blacklistyeppo and chat.admin_rights:
            try:
