    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 Hai** {mention}**!**\
                        ...
                        \n**Anda Dapat Menghubungi [{OWNER}](tg://user?id={OWNER_ID}) Dari Sini Atau Join Channel Dibawah.**\
                        \n**Jangan melakukan spam atau anda akan di Banned**\
                        \n\n**Powered by 🐣** [ICHiHOOD USERBOT](t.me/ICHiHOOD)"
        ...
        start_msg = f"""
            **\n\n 🤖 ꜱᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ ɪᴄʜɪʜᴏᴏᴅ ᴜꜱᴇʀʙᴏᴛ 🤖**
            **\n➖ 👋 ʜᴀʟʟᴏ [{𝐎𝐖𝐍𝐄𝐑}](tg://user?id={OWNER_ID})**
            **\n➖ 📁 ᴋᴇᴛɪᴋ .ʜᴇʟᴘ ᴜɴᴛᴜᴋ ᴍᴇʟɪʜᴀᴛ ᴘʟᴜɢɪɴꜱ ** """
        buttons = [
            # (Button.inline("sᴇᴛᴛɪɴɢs ᴠᴀʀ", data="apiset"),),
            # (Button.inline("ᴘʟᴜɢɪɴ", data="plugin"),),
            (
