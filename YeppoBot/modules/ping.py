...
from YeppoBot.yeppo import edit_or_reply, humanbytes, yeppo_cmd
...
@yeppo_cmd(pattern="ping$")
async def _(ping):
    uptime = await get_readable_time((time.time() - StartTime))
    start = datetime.now()
    yeppo = await edit_or_reply(ping, "**✩**")
    await yeppo.edit("**㋡㋡**")
    await yeppo.edit("**㋡㋡㋡**")
    await yeppo.edit("**㋡㋡㋡㋡**")
    await yeppo.edit("**㋡㋡㋡㋡㋡**")
