...
from YeppoBot.modules.sql_helper import broadcast_sql as sql
from YeppoBot.yeppo import yeppo_cmd, eor, parse_pre
from Stringyins import get_string


@yeppo_cmd(pattern=r"sendto ?(.*)")
