...
@yeppo_cmd(pattern="remove(?: |$)(.*)", allow_sudo=False)
async def _(event):
    if event.fwd_from:
        return
    if event.is_private:
...
@yeppo_cmd(pattern="doublestruck(?: |$)(.*)")
