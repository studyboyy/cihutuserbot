...
from YeppoBot import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY
from YeppoBot.yeppo import yeppo_cmd, eor, humanbytes, progress, run_cmd
from YeppoBot.yeppo.FastTelethon import download_file, upload_file
from Stringyins import get_string


@yeppo_cmd(pattern="download(?: |$)(.*)")
