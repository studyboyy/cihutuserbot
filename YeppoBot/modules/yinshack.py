# © Copyright 2021 yeppo-Userbot LLC Company.
...
@yeppo_cmd(pattern=r"hacking(?: |$)(.*)")
async def _(kontol):
    yeppo = await edit_or_reply(kontol, "Installing.")
    await yeppo.edit("Installing..")
    await yeppo.edit("Installing...")
    await yeppo.edit("Installing....")
    sleep(3)
    await yeppo.edit("`Installing Files To Hacked Private Server...`")
    sleep(3)
    await yeppo.edit("`Target Selected.`")
    sleep(4)
    await yeppo.edit("`Installing... 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await yeppo.edit("`Installing... 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await yeppo.edit("`Installing... 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await yeppo.edit("`lnstallig... 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await yeppo.edit("`Installing... 36%\n█████████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(3)
    await yeppo.edit("`Installing... 52%\n█████████████▒▒▒▒▒▒▒▒▒▒▒▒ `")
    sleep(2)
    await yeppo.edit("`Installing... 84%\n█████████████████████▒▒▒▒ `")
    sleep(2)
    await yeppo.edit("`Installing... 100%\n████████Installed██████████ `")
    sleep(2)
    await yeppo.edit("`Target files Uploading...\n\nDirecting To Remote  server to hack..`")
    sleep(3)
    await yeppo.edit("Connecting nd getting combined token from my.telegram.org ")
    sleep(3)
    await yeppo.edit("`root@anon:~#` ")
    sleep(2)
    await yeppo.edit("`root@anon:~# ls`")
    sleep(3)
    await yeppo.edit("`root@anon:~# ls\n\n  usr  ghost  codes  \n\nroot@aono:~#`")
    sleep(3)
    await yeppo.edit("`root@anon:~# ls\n\n  usr  ghost  codes  \n\nroot@aono:~# # S`")
