...
from YeppoBot import CMD_HELP, LOGS, INLINE_PIC
from YeppoBot.yeppo import yeppo_cmd, bash, eod, eor
from YeppoBot.yeppo.pytgcalls import (
    add_to_queue,
    mediainfo,
    file_download,
    is_url_ok,
...
@yeppo_cmd(pattern="end$")
async def mute(event):
    chat_id = event.chat_id
    if chat_id in VC_QUEUE:
        try:
            await yeppo(chat_id).group_call.leave()
