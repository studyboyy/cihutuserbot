...
from YeppoBot.events import register as own_cmd
from YeppoBot.modules.yinsping import absen
from YeppoBot.yeppo import edit_or_reply, yeppo_cmd


@yeppo_cmd(pattern="bulan$")
async def _(event):
