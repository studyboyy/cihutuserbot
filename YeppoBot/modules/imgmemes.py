...
from YeppoBot import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
from YeppoBot.yeppo import yeppo_cmd, bash, deEmojify
...
async def FakeGoogleSearch(event):
    ...
    font1 = ImageFont.truetype(
        "YeppoBot/yeppo/styles/ProductSans-BoldItalic.ttf", 20)
    font2 = ImageFont.truetype(
        "YeppoBot/yeppo/styles/ProductSans-Light.ttf", 23)
...
CMD_HELP.update(
    {
        ...
        \n  •  **Example  : **{cmd}tweet @yeppo.ganteng (harus pake . [titik])\
    "
    }
)
