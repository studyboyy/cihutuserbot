...
@yeppo_cmd(pattern="(d)?fban(?: |$)(.*)")
async def fban(event):
    """Bans a user from connected federations."""
    try:
        from YeppoBot.modules.sql_helper.fban_sql import get_flist
...
@yeppo_cmd(pattern="addf(?: |$)(.*)")
async def addf(event):
    """Adds current chat to connected federations."""
    try:
        from YeppoBot.modules.sql_helper.fban_sql import add_flist
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
...
@yeppo_cmd(pattern="delf$")
async def delf(event):
    """Removes current chat from connected federations."""
    try:
        from YeppoBot.modules.sql_helper.fban_sql import del_flist
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
...
@yeppo_cmd(pattern="clearf$")
async def clearf(event):
    """Removes all chats from connected federations."""
    try:
        from YeppoBot.modules.sql_helper.fban_sql import del_flist_all
    except IntegrityError:
        return await event.edit(get_string("not_sql"))
