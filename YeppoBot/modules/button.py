...
from YeppoBot import CMD_HELP, tgbot
from YeppoBot.yeppo import yeppo_cmd, edit_delete, reply_id
...
@yeppo_cmd(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@yeppo_cmd(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/yeppoSupport:same> [Support]<buttonurl:https://t.me/YeppoBotSupport>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/yeppoSupport:same> [Support]<buttonurl:https://t.me/YeppoBotSupport>`\
    "
    }
)
