...
@yeppo_cmd(pattern="name", allow_sudo=False)
...
@yeppo_cmd(pattern="setpfp$", allow_sudo=False)
...
@yeppo_cmd(pattern="setbio (.*)", allow_sudo=False)
...
@yeppo_cmd(pattern="username (.*)", allow_sudo=False)
...
@yeppo_cmd(pattern="delpfp", allow_sudo=False)
