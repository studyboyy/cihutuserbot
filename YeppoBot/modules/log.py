...
from YeppoBot import CMD_HELP, LOGS, bot
from YeppoBot.modules.sql_helper import no_log_pms_sql
from YeppoBot.modules.sql_helper.globals import addgvar, gvarstatus
from YeppoBot.modules.carbon import vcmention
from YeppoBot.yeppo import _format, yeppo_cmd, edit_delete, edit_or_reply
from YeppoBot.yeppo.tools import media_type
...
@yeppo_cmd(pattern="pmlog (on|off)$")
...
@yeppo_cmd(pattern="gruplog (on|off)$")
