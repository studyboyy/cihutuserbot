...
from YeppoBot import BLACKLIST_GCAST
from YeppoBot import CMD_HANDLER as cmd
from YeppoBot import CMD_HELP, DEVS, HEROKU_API_KEY, HEROKU_APP_NAME
from YeppoBot.yeppo import yeppo_cmd, eod, eor
from Stringyins import get_string

GCAST_BLACKLIST = [
    -1001675396283,  # YeppoBotSupport
...
@yeppo_cmd(pattern="addblacklist(?:\\s|$)([\\s\\S]*)")
async def add(event):
...
@yeppo_cmd(pattern="delblacklist(?:\\s|$)([\\s\\S]*)")
async def _(event):
