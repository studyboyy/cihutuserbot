...
from YeppoBot import AFKREASON, BOTLOG_CHATID, PM_AUTO_BAN
from YeppoBot.yeppo import yeppo_cmd, yeppo_handler
...
@yeppo_handler(incoming=True, func=lambda e: e.is_private)
async def afk_on_pm(sender):
    ...
    global afk_end
    back_alivee = datetime.now()
    yeppoBot = await sender.client.get_me()
    owner = yeppoBot.first_name
    afk_end = back_alivee.replace(microsecond=0)
