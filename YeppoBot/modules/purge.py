...
from YeppoBot.yeppo import yeppo_cmd, eod
from Stringyins import get_string


@yeppo_cmd(pattern="purge$")
...
@yeppo_cmd(pattern=r"(p|purge)(from$|to$)")
