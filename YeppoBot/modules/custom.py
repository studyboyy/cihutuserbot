...
from YeppoBot.modules.sql_helper import snips_sql as sql
from YeppoBot.yeppo import edit_delete, edit_or_reply, yeppo_cmd, reply_id


@yeppo_cmd(pattern=r"\#(\S+)")
...
@yeppo_cmd(pattern="custom(?:\\s|$)([\\s\\S]*)")
...
@yeppo_cmd(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
