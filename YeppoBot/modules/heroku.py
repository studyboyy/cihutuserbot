...
from YeppoBot import CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME
...
@yeppo_cmd(pattern="(get|del) var(?: |$)(\\w*)", allow_sudo=False)
...
@yeppo_cmd(pattern="set var (\\w*) ([\\s\\S]*)", allow_sudo=False)
...
@yeppo_cmd(pattern="(usage|kuota|dyno)(?: |$)")
...
@yeppo_cmd(pattern="getdb ?(.*)", allow_sudo=False)
...
@yeppo_cmd(pattern="setdb ?(.*)", allow_sudo=False)
...
@yeppo_cmd(pattern="deldb ?(.*)", allow_sudo=False)
...
CMD_HELP.update(
    {
        ...
        \n  »  **Kegunaan : **Tambahkan Variabel Baru Atau Memperbarui Variabel Setelah Menyetel Variabel Uputt-Userbot Akan Di Restart.\
