...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            # else:
            #     result = builder.article(
            #         title="ICHiHOOD 𝚄𝚂𝙴𝚁𝙱𝙾𝚃",
            #         description="ICHiHOOD 𝚄𝚂𝙴𝚁𝙱𝙾𝚃 | Telethon",
            #         url="https://t.me/ICHiHOOD",
            #         thumb=InputWebDocument(
            #             INLINE_PIC,
            #             0,
            #             "image/jpeg",
            #             []),
            #         text=f"**ICHiHOOD 𝚄𝚂𝙴𝚁𝙱𝙾𝚃**\n➖➖➖➖➖➖➖➖➖➖\n✧ **ᴏᴡɴᴇʀ :** [{user.first_name}](tg://user?id={user.id})\n✧ **ᴀssɪsᴛᴀɴᴛ:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**ᴜᴘᴅᴀᴛᴇs :** @ICHiHOOD\n➖➖➖➖➖➖➖➖➖➖",
            #         buttons=[
            #             [
            #                 custom.Button.url(
            #                     "ɢʀᴏᴜᴘ",
